...
exports.SmsCheckoutOperationAcceptLanguageEnum = exports.GetCheckoutsAcceptLanguageEnum = exports.GetCheckoutAcceptLanguageEnum = exports.EmailCheckoutOperationAcceptLanguageEnum = exports.CreateCheckoutAcceptLanguageEnum = exports.CancelCheckoutAcceptLanguageEnum = exports.PaymentLinkApi = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class PaymentLinkApi extends runtime.BaseAPI {
    /**
     * Cancel Payment Link
     */
    cancelCheckoutRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CheckoutResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Cancel Payment Link
    ...
    createCheckoutRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CheckoutToJSON)(requestParameters.checkout),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CheckoutResponseFromJSON)(jsonValue));
        });
    }
    ...
    emailCheckoutRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.EmailCheckoutRequestToJSON)(requestParameters.emailCheckoutRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CheckoutResponseFromJSON)(jsonValue));
        });
    }
    ...
    getCheckoutsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CheckoutsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Returns a list of links generated by the merchant
    ...
    smsCheckoutRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.SmsCheckoutRequestToJSON)(requestParameters.smsCheckoutRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CheckoutResponseFromJSON)(jsonValue));
        });
    }
...
exports.PaymentLinkApi = PaymentLinkApi;
/**
 * @export
 */
exports.CancelCheckoutAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.CreateCheckoutAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.EmailCheckoutOperationAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.GetCheckoutAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.GetCheckoutsAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.SmsCheckoutOperationAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
