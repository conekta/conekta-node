...
exports.GetTransactionsAcceptLanguageEnum = exports.GetTransactionAcceptLanguageEnum = exports.TransactionsApi = void 0;
...
class TransactionsApi extends runtime.BaseAPI {
    ...
    getTransactionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.GetTransactionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Get transaction details in the form of a list
