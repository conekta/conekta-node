...
exports.OrdersUpdateProductAcceptLanguageEnum = exports.OrdersDeleteProductAcceptLanguageEnum = exports.OrdersCreateProductAcceptLanguageEnum = exports.ProductsApi = void 0;
    ...
    ordersCreateProductRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.ProductToJSON)(requestParameters.product),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ProductOrderResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Create a new product for an existing order.
    ...
    ordersUpdateProductRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateProductToJSON)(requestParameters.updateProduct),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ProductOrderResponseFromJSON)(jsonValue));
        });
    }
