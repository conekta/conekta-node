...
exports.UpdateWebhookAcceptLanguageEnum = exports.GetWebhooksAcceptLanguageEnum = exports.GetWebhookAcceptLanguageEnum = exports.DeleteWebhookAcceptLanguageEnum = exports.CreateWebhookAcceptLanguageEnum = exports.WebhooksApi = void 0;
...
class WebhooksApi extends runtime.BaseAPI {
    ...
    createWebhookRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.WebhookRequestToJSON)(requestParameters.webhookRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.WebhookResponseFromJSON)(jsonValue));
        });
    }
    /**
     * What we do at Conekta translates into events. For example, an event of interest to us occurs at the time a payment is successfully processed. At that moment we will be interested in doing several things: Send an email to the buyer, generate an invoice, start the process of shipping the product, etc.
    ...
    getWebhooksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.GetWebhooksResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Consume the list of webhooks you have, each environment supports 10 webhooks (For production and testing)
    ...
    updateWebhookRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.WebhookUpdateRequestToJSON)(requestParameters.webhookUpdateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.WebhookResponseFromJSON)(jsonValue));
        });
    }
 ...
 * @export
 */
exports.CreateWebhookAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.DeleteWebhookAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.GetWebhookAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.GetWebhooksAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
/**
 * @export
 */
exports.UpdateWebhookAcceptLanguageEnum = {
    Es: 'es',
    En: 'en'
};
