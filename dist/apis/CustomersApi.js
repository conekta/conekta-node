...
class CustomersApi extends runtime.BaseAPI {
    ...
    createCustomerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CustomerResponseFromJSON)(jsonValue));
        });
    }
    /**
     * The purpose of business is to create and keep a customer, you will learn what elements you need to create a customer. Remember the credit and debit card tokenization process: [https://developers.conekta.com/page/web-checkout-tokenizer](https://developers.conekta.com/page/web-checkout-tokenizer)
    ...
    createCustomerFiscalEntitiesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CustomerFiscalEntitiesRequestToJSON)(requestParameters.customerFiscalEntitiesRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateCustomerFiscalEntitiesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Create Fiscal entity resource that corresponds to a customer ID.
    ...
    getCustomersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CustomersResponseFromJSON)(jsonValue));
        });
    }
    /**
     * The purpose of business is to create and maintain a client, you will learn what elements you need to obtain a list of clients, which can be paged.
    ...
    updateCustomerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateCustomerToJSON)(requestParameters.updateCustomer),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CustomerResponseFromJSON)(jsonValue));
        });
    }
    ...
    updateCustomerFiscalEntitiesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CustomerUpdateFiscalEntitiesRequestToJSON)(requestParameters.customerUpdateFiscalEntitiesRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateCustomerFiscalEntitiesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Update Fiscal Entity resource that corresponds to a customer ID.
