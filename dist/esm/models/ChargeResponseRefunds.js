 ...
 */
export function instanceOfChargeResponseRefunds(value) {
    let isInstance = true;
    isInstance = isInstance && "object" in value;
    isInstance = isInstance && "hasMore" in value;
    return isInstance;
}
export function ChargeResponseRefundsFromJSON(json) {
    return ChargeResponseRefundsFromJSONTyped(json, false);
}
export function ChargeResponseRefundsFromJSONTyped(json, ignoreDiscriminator) {
...
export function ChargeResponseRefundsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
