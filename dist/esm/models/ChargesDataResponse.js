 ...
 */
export function instanceOfChargesDataResponse(value) {
    let isInstance = true;
    return isInstance;
}
export function ChargesDataResponseFromJSON(json) {
    return ChargesDataResponseFromJSONTyped(json, false);
}
export function ChargesDataResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ChargesDataResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
