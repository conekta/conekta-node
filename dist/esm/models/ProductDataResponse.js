 ...
 */
export function instanceOfProductDataResponse(value) {
    let isInstance = true;
...
export function ProductDataResponseFromJSON(json) {
    return ProductDataResponseFromJSONTyped(json, false);
}
export function ProductDataResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ProductDataResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
