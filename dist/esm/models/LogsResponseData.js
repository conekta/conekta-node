 ...
 */
export function instanceOfLogsResponseData(value) {
    let isInstance = true;
    return isInstance;
}
export function LogsResponseDataFromJSON(json) {
    return LogsResponseDataFromJSONTyped(json, false);
}
export function LogsResponseDataFromJSONTyped(json, ignoreDiscriminator) {
...
export function LogsResponseDataToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
