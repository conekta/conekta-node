 ...
 */
export declare function instanceOfTransfersResponse(value: object): boolean;
export declare function TransfersResponseFromJSON(json: any): TransfersResponse;
export declare function TransfersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransfersResponse;
export declare function TransfersResponseToJSON(value?: TransfersResponse | null): any;
