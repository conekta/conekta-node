 ...
 */
export function instanceOfPaymentMethodCash(value) {
    let isInstance = true;
    isInstance = isInstance && "object" in value;
    return isInstance;
}
export function PaymentMethodCashFromJSON(json) {
    return PaymentMethodCashFromJSONTyped(json, false);
}
export function PaymentMethodCashFromJSONTyped(json, ignoreDiscriminator) {
...
export function PaymentMethodCashToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
