...
exports.CustomerPaymentMethodsDataToJSON = exports.CustomerPaymentMethodsDataFromJSONTyped = exports.CustomerPaymentMethodsDataFromJSON = void 0;
...
function CustomerPaymentMethodsDataFromJSON(json) {
    return CustomerPaymentMethodsDataFromJSONTyped(json, false);
}
exports.CustomerPaymentMethodsDataFromJSON = CustomerPaymentMethodsDataFromJSON;
function CustomerPaymentMethodsDataFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CustomerPaymentMethodsDataFromJSONTyped = CustomerPaymentMethodsDataFromJSONTyped;
function CustomerPaymentMethodsDataToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CustomerPaymentMethodsDataToJSON = CustomerPaymentMethodsDataToJSON;
