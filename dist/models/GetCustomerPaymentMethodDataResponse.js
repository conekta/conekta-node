...
exports.GetCustomerPaymentMethodDataResponseToJSON = exports.GetCustomerPaymentMethodDataResponseFromJSONTyped = exports.GetCustomerPaymentMethodDataResponseFromJSON = void 0;
...
function GetCustomerPaymentMethodDataResponseFromJSON(json) {
    return GetCustomerPaymentMethodDataResponseFromJSONTyped(json, false);
}
exports.GetCustomerPaymentMethodDataResponseFromJSON = GetCustomerPaymentMethodDataResponseFromJSON;
function GetCustomerPaymentMethodDataResponseFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GetCustomerPaymentMethodDataResponseFromJSONTyped = GetCustomerPaymentMethodDataResponseFromJSONTyped;
function GetCustomerPaymentMethodDataResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GetCustomerPaymentMethodDataResponseToJSON = GetCustomerPaymentMethodDataResponseToJSON;
