...
const TransferDestinationResponse_1 = require("./TransferDestinationResponse");
/**
...
function TransferResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'destination': !(0, runtime_1.exists)(json, 'destination') ? undefined : (0, TransferDestinationResponse_1.TransferDestinationResponseFromJSON)(json['destination']),
...
function TransferResponseToJSON(value) {
    ...
    return {
        ...
        'destination': (0, TransferDestinationResponse_1.TransferDestinationResponseToJSON)(value.destination),
        'object': value.object,
