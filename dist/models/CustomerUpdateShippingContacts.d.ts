 ...
 */
export declare function instanceOfCustomerUpdateShippingContacts(value: object): boolean;
export declare function CustomerUpdateShippingContactsFromJSON(json: any): CustomerUpdateShippingContacts;
export declare function CustomerUpdateShippingContactsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerUpdateShippingContacts;
export declare function CustomerUpdateShippingContactsToJSON(value?: CustomerUpdateShippingContacts | null): any;
