 ...
 * @export
 */
export type ChargeResponsePaymentMethod = { object: 'bank_transfer_payment' } & PaymentMethodBankTransfer | { object: 'bnpl_payment' } & PaymentMethodBnplPayment | { object: 'card_payment' } & PaymentMethodCard | { object: 'cash_payment' } & PaymentMethodCash | { object: 'pay_by_bank_payment' } & PaymentMethodPbbPayment;
