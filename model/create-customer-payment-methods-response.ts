 ...
 * @export
 */
export type CreateCustomerPaymentMethodsResponse = { type: 'card' } & PaymentMethodCardResponse | { type: 'cash' } & PaymentMethodCashResponse | { type: 'cash_recurrent' } & PaymentMethodCashResponse | { type: 'oxxo_recurrent' } & PaymentMethodCashResponse | { type: 'spei_recurrent' } & PaymentMethodSpeiRecurrent;
