 ...
 * @export
 */
export type CreateCustomerPaymentMethodsResponse = { type: 'card' } & PaymentMethodCardResponse | { type: 'cash' } & PaymentMethodCashResponse | { type: 'cash_recurrent' } & PaymentMethodCashRecurrentResponse | { type: 'spei_recurrent' } & PaymentMethodSpeiRecurrent;
