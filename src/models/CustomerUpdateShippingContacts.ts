 ...
 */
export function instanceOfCustomerUpdateShippingContacts(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CustomerUpdateShippingContactsFromJSON(json: any): CustomerUpdateShippingContacts {
    return CustomerUpdateShippingContactsFromJSONTyped(json, false);
}

export function CustomerUpdateShippingContactsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerUpdateShippingContacts {
    ...
    return {
        ...
        'address': !exists(json, 'address') ? undefined : CustomerShippingContactsAddressFromJSON(json['address']),
...
export function CustomerUpdateShippingContactsToJSON(value?: CustomerUpdateShippingContacts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
