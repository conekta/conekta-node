 ...
 */
export function instanceOfCheckoutOrderTemplate(value: object): boolean {
    let isInstance = true;
...
export function CheckoutOrderTemplateFromJSON(json: any): CheckoutOrderTemplate {
    return CheckoutOrderTemplateFromJSONTyped(json, false);
}

export function CheckoutOrderTemplateFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckoutOrderTemplate {
...
export function CheckoutOrderTemplateToJSON(value?: CheckoutOrderTemplate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
