 ...
 */
export function instanceOfChargeDataPaymentMethodCashResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChargeDataPaymentMethodCashResponseFromJSON(json: any): ChargeDataPaymentMethodCashResponse {
    return ChargeDataPaymentMethodCashResponseFromJSONTyped(json, false);
}

export function ChargeDataPaymentMethodCashResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeDataPaymentMethodCashResponse {
...
export function ChargeDataPaymentMethodCashResponseToJSON(value?: ChargeDataPaymentMethodCashResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
