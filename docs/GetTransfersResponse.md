...
**data** | [**Array&lt;TransfersResponse&gt;**](TransfersResponse.md) | Transfers | [optional] [default to undefined]

## Example

```typescript
import { GetTransfersResponse } from 'conekta';

const instance: GetTransfersResponse = {
    has_more,
    object,
    next_page_url,
    previous_page_url,
