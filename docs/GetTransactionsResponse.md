...
**data** | [**Array&lt;TransactionResponse&gt;**](TransactionResponse.md) | Transactions | [optional] [default to undefined]

## Example

```typescript
import { GetTransactionsResponse } from 'conekta';

const instance: GetTransactionsResponse = {
    has_more,
    object,
    next_page_url,
    previous_page_url,
