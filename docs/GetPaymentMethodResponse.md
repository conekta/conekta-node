...
**data** | [**Array&lt;GetCustomerPaymentMethodDataResponse&gt;**](GetCustomerPaymentMethodDataResponse.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetPaymentMethodResponse } from 'conekta';
