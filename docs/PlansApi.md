...
|------------- | ------------- | -------------|
|[**createPlan**](#createplan) | **POST** /plans | Create Plan|
|[**deletePlan**](#deleteplan) | **DELETE** /plans/{id} | Delete Plan|
|[**getPlan**](#getplan) | **GET** /plans/{id} | Get Plan|
|[**getPlans**](#getplans) | **GET** /plans | Get A List of Plans|
|[**updatePlan**](#updateplan) | **PUT** /plans/{id} | Update Plan|
...
let planRequest: PlanRequest; //requested field for plan
