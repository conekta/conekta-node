...
**data** | [**Array&lt;CustomerPaymentMethodsData&gt;**](CustomerPaymentMethodsData.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CustomerPaymentMethodsResponse } from 'conekta';

const instance: CustomerPaymentMethodsResponse = {
    has_more,
    object,
    next_page_url,
    previous_page_url,
