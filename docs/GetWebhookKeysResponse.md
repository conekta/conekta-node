...
**data** | [**Array&lt;WebhookKeyResponse&gt;**](WebhookKeyResponse.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetWebhookKeysResponse } from 'conekta';

const instance: GetWebhookKeysResponse = {
    has_more,
    object,
    next_page_url,
    previous_page_url,
